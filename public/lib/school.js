...
db.student.insert(firstGrade, { unique: true });
db.student.insert(secondGrade, { unique: true });
db.student.insert(thirdGrade, { unique: true });
db.student.insert(fourthGrade, { unique: true });
db.student.insert(fifthGrade, { unique: true });
